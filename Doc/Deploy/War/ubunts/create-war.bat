...
rem ============================================================
rem photoDiary WAR Build Script (for ubunts deploy)
rem Run this script from: Doc\Deploy\War\ubunts\
rem ============================================================
...
echo ==============================================
echo  photoDiary WAR Build Start (ubunts)
echo ==============================================
...
echo ==============================================
echo  Build Complete!
echo  Transfer to Ubuntu, then run:
