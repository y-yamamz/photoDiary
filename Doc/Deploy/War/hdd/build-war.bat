...
rem
rem このスクリプトは Doc\Deploy\War\hdd\ から実行してください
rem ============================================================
...
echo [2/4] Copying backend.war to hdd folder...
...
echo    cd Doc\Deploy\War\hdd
echo    docker compose -f docker-compose.hdd.yml up -d --build
echo ==============================================
goto :end
